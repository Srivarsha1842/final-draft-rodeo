...
async function main() {
  ...
  const prop1 = await prisma.property.upsert({
    ...
    create: {
      ...
      fullAddress: 'North Goa, Goa, India',
      city: 'Goa',
      state: 'Goa',
      country: 'India',
      latitude: 15.4989,
      ...
      tags: ['Sea View', 'Private Pool', 'Superhost', 'Verified', 'Beach Front', 'Private Stays'],
      isExclusive: true,
  ...
  const prop2 = await prisma.property.upsert({
    ...
    create: {
      ...
      fullAddress: 'Manali, Himachal Pradesh, India',
      city: 'Manali',
      ...
      tags: ['Mountain View', 'Fireplace', 'Adventure', 'School Trips'],
  ...
  const prop3 = await prisma.property.upsert({
    ...
    create: {
      ...
      fullAddress: 'Ranthambore, Rajasthan, India',
      city: 'Sawai Madhopur',
      state: 'Rajasthan',
      country: 'India',
      latitude: 26.0173,
      ...
      tags: ['Wildlife', 'Safari', 'Luxury', 'Superhost', 'Corporate Getaways'],
      isExclusive: true,
  ...
  await prisma.property.upsert({
    ...
    create: {
      ...
      fullAddress: 'Alleppey, Kerala, India',
      city: 'Alleppey',
      state: 'Kerala',
      country: 'India',
      latitude: 9.4981,
      ...
      tags: ['Backwaters', 'Unique Stay', 'Romantic', 'Private Stays'],
  ...
  await prisma.property.upsert({
    ...
    create: {
      ...
      fullAddress: 'Madikeri, Coorg, Karnataka, India',
      city: 'Madikeri',
      state: 'Karnataka',
      country: 'India',
      latitude: 12.4244,
      ...
      tags: ['Coffee Estate', 'Nature', 'Offbeat', 'Pet Friendly', 'School Trips'],
  ...
  await prisma.property.upsert({
    ...
    create: {
      ...
      tags: ['Heritage', 'Lake View', 'Royal', 'Butler Service', 'Corporate Getaways'],
      isExclusive: true,
